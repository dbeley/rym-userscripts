...
(function () {
  ...
  async function loadDatabases() {
    try {
      ...
      console.info(`[deezer-rym-ratings] Loaded ${sc} songs and ${rc} releases`);
      if (sc === 0 && rc === 0) {
        console.warn("[deezer-rym-ratings] No data. Use 'Load RYM CSV' menu commands.");
      }
    } catch (err) {
      console.error("[deezer-rym-ratings] Failed to load:", err);
    }
  }
